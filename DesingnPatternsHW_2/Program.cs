...
public class VictorianCoffeeTable : ICoffeeTable
{
    ...
    public void PlaceOn() => Console.WriteLine($"Placed on {nameof(VictorianCoffeeTable)}");
}
...
public class ArtDecoCoffeeTable : ICoffeeTable
{
    ...
    public void PlaceOn() => Console.WriteLine($"Placed on {nameof(ArtDecoCoffeeTable)}");
}
...
{
    public void HasLegs() => Console.WriteLine("Has Legs");
    public void SitOn() => Console.WriteLine($"Sat on {nameof(VictorianSofa)}");
...
{
    public void HasLegs() => Console.WriteLine("Has No Legs");
    public void SitOn() => Console.WriteLine($"Sat on {nameof(ModernSofa)}");
}

public class ArtDecoSofa : ISofa
{
    public void HasLegs() => Console.WriteLine("Has Legs");
    public void SitOn() => Console.WriteLine($"Sat on {nameof(ArtDecoSofa)}");
